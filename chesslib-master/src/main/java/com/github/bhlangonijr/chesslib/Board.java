...
//        this.eventListener = new EnumMap<BoardEventType, List<BoardEventListener>>();
//        this.bitboard = b.bitboard;
//        this.bbSide = b.bbSide;
...
//        this.moveCounter = b.moveCounter;
//        this.halfMoveCounter = b.halfMoveCounter;
//        this.enableEvents = b.enableEvents;
//        this.updateHistory = b.updateHistory;
//        this.incrementalHashKey = b.incrementalHashKey;
//        this.loadFromFen(b.getFen());
//
//
//    }
    /**
    ...
    public int countSquaresAttackedBy(List<Square> squares, Side side) {
        int count = 0;
        for (Square sq : squares) {
            if (squareAttackedBy(sq, side) != 0L) {
                count++;
